const Footer = () => {
    return (
        <footer className="bg-black text-[#B8860B] text-center py-10 relative">
            {/* Gold Top Border */}
            ...
            <div className="max-w-full mx-auto flex flex-col md:flex-row items-center justify-between px-6 space-y-8 md:space-y-0">
                ...
                <div className="w-full md:w-3/10 flex flex-col items-center justify-center text-center">
                    <div className="flex items-center space-x-4">
                        <img src="/tesla-logo.png" alt="Tesla Logo" className="h-12 md:h-16" />
                        <img src="/jss-logo.png" alt="JSS Logo" className="h-12 md:h-16" />
                    </div>
                ...
                <div className="w-full md:w-7/10 flex flex-col items-center justify-center text-center">
                    {/* Subscribe Section */}
                    <div className="w-full sm:w-3/5 flex items-center mb-6 border border-[#B8860B] rounded-full overflow-hidden">
                        <input
                            type="email"
                            placeholder="E-MAIL"
                    ...
                    {/* Links Section */}
                    <div className="w-full sm:w-4/5 grid grid-cols-1 sm:grid-cols-3 gap-6 text-lg text-left">
                        <div>
                            <h3 className="font-bold uppercase text-center sm:text-left">COLLEGE CLUB</h3>
                        ...
                        <div>
                            <h3 className="font-bold uppercase text-center sm:text-left">SOCIAL MEDIA</h3>
                            <ul className="space-y-1 text-center sm:text-left">
                                <li>Instagram</li>
                                <li>LinkedIn</li>
                            </ul>
                        ...
                        <div>
                            <h3 className="font-bold uppercase text-center sm:text-left">GET HELP</h3>
                            <ul className="space-y-1 text-center sm:text-left">
                                <li>FAQ</li>
                                <li>Contact Us</li>
                            </ul>
