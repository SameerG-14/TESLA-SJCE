...
const InitialSection = forwardRef((props, ref) => {
  ...
  return (
    ...
    >
      ...
      >
        <img src="/tesla_logo.png" alt="hgfdhfdc"  className="h-48 md:min-h-auto"/>
        <h1 className="text-8xl sm:text-7xl font-bold text-[var(--gold)] tracking-tight">
          TESLA-SJCE
        </h1>
        <p className="text-[var(--off-white)] text-base sm:text-xl mt-4 max-w-lg">
